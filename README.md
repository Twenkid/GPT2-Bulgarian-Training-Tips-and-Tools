...
* Обогатяване на данните (Data Augmentation, DA): чрез: синонимна замяна (синонимен речник), разпознаване на лични имена и замяна и обща замяна по класове, промяна на съгласуване и местоимения, единично и мн.ч., времена и пр. 
