...
* Читанка - подбор; текстов формат; изчистване на края, линкове, подчертаване ```_абвг_, _абфд и дведе_, __нещо си__``` ... Внимание с творби с прекалено много повторения на имената на герои - замърсява модела, еднообразие.
* Мои произведения - изчистване ...
* Обогатяване на данните: чрез ... 
